(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Borussia Dortmund GmbH & Co.
  Kommanditgesellschaft auf Aktien, LEI 529900XO0YTOOKCLQB44) -- unlike
...
(defn demo-company []
  {:legal-name "Borussia Dortmund GmbH & Co. Kommanditgesellschaft auf Aktien"
   :website    "https://www.bvb.de"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. BVB.de is an informational service operated by Borussia Dortmund GmbH & Co. Kommanditgesellschaft auf Aktien for its professional football club and is provided for information purposes only, subject to change without notice. These Terms are governed by the laws of the Federal Republic of Germany.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.bvb.de/de/en/general/terms-of-use.html"
